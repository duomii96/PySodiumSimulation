...
import numpy as np
from Classes.PhaseCycles_VecDic2 import PhaseCyclesVecDic2
import time
...
PC = PhaseCyclesVecDic2(B0, tauC, wQ, 0.0, Jen, 0.0, 0.0, 0.0)
...
#result = PC.TQTPPIWith180_batched()



"""result2 = PC.TQTPPIWith180_batched(chunk_size=32)
t2 = time.perf_counter()
print("second call (JIT warm):", t2 - t1)"""
...
if spinEcho:
    ...
    t0 = time.time()
    acqTimeVec, mqSpectrum, mqFID, FIDs, fAngles90, tevos = PC.TQTPPIWith180_batched()
    t1 = time.time()
    print("Total Time: s ", t1 - t0)
